<template>
  <div class="introduction">
    ...
    <svg version="1.1" id="calque_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	      viewBox="0 0 98.1 58.2" style="enable-background:new 0 0 98.1 58.2;" xml:space="preserve" class="home-logo">
    ...
    <h1 class="title"><span class="decorator">Developer,</span> Photographer <span class="gradient">&</span> SwiftUI lover.</h1>
