...
<template>
  <div class="header-container">
    <RouterLink :to="'/works'" class="back-button"><h4 style="margin-bottom: .8em;"><i class="fa-solid fa-arrow-left-long" style="margin-right: 8px;"></i> Back</h4></RouterLink>
    ...
    <div class="see-it-live"> <a :href="currentProject.href" target="_blank" class="live-link links" v-html="currentProject.cta_label"></a></div>
